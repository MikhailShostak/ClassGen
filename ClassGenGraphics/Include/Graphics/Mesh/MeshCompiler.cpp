...
void MeshCompiler::Compile(const SharedReference<ClassGen::BaseInfo>& BaseInfo, const System::Path& OutputFilePath)
{
    ...
    file << "\n";
    file << "inline DynamicAsset<Graphics::Mesh> " << name << " = { \"" << name << "\", [](auto &instance)\n{\n";
